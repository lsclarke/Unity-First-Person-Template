# Getting started with Virtual Players
...
**Note**
You can only attach tags to inactive Players (including the main Editor Player). To use tags, [create and configure your tags](../player-tags/player-tags.md) before you enable virtual Players.
...
**Note**
When you deactivate a Virtual Player, Unity doesn't delete its corresponding folder. To remove a Virtual Player folder, navigate to `[ProjectPath]/Library/VP` and delete the folder for this Virtual Player.
