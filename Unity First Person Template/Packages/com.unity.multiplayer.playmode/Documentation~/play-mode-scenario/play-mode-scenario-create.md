...
1. Select the Play Mode dropdown menu.
2. Select **Configure play mode scenarios…**.
3. In the Play Mode Scenarios window toolbar, select the (**+**) icon to create a new scenario.
4. Select the (**+**) icon under **Editor Instances**, **Local Instances**, or **Remote Instances**.
5. Select the picker for the Build Profiles property.
6. Select the Build Profile to assign to this instance.
